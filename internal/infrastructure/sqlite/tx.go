...
// execer above), and commits on success. Any error from fn — or from the
// commit itself — rolls the transaction back; the original error is
// returned, joined with a rollback failure if one also occurs.
