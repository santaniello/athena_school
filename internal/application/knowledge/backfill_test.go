...
func TestCountUnindexedItems_delegatesToTheRepositoryWithTheCurrentEmbeddingModel(t *testing.T) {
	...
	service := NewService(repository, nil, nil, nil, nil, nil, domainknowledge.RetrievalThresholds{}, nil)
...
func TestReindexKnowledgeItems_propagatesTheListError(t *testing.T) {
	...
	service := NewService(repository, nil, nil, nil, nil, passingIndexGuard(t), domainknowledge.RetrievalThresholds{}, nil)
