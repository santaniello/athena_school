...
| 2 | On-demand knowledge extraction with draft review (session transcript sent to OpenRouter only when requested), personal knowledge base, Markdown/plain-text folder or single-file notes import, RAG retrieval |
